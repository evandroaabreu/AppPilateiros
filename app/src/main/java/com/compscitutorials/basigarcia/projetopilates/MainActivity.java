...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MainMesDiaTelaCustom fragment = new MainMesDiaTelaCustom();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_send) {
            ...
            MainSinc fragment = new MainSinc();
            FragmentTransaction fragmentTransaction = this.getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.fragment_container, (Fragment)fragment);
            fragmentTransaction.commit();

        }else if (id == R.id.nav_geratabledados) {
            MainGeraTables fragment = new MainGeraTables();
            FragmentTransaction fragmentTransaction = this.getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.fragment_container, (Fragment)fragment);
            fragmentTransaction.commit();
